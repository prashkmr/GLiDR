...
with torch.no_grad():
  ...
  for i in npydata:
    ...
    print('Loading')
    lidar_static    = (np.load(args.data + "{}.npy".format(str(i)))[:,:,::int(64/args.beam),::args.dim].astype('float32'))
    lidar_dynamic   = (np.load(args.data + "{}.npy".format(str(i)))[:,:,::int(64/args.beam),::args.dim].astype('float32'))
    print('Loaded')
    ...
    for batch in loader:
        ...
        # exit(0)
        # print(lidar_d.shape, lidar_s.shape, recon.shape)
        # print(recon.shape)
        # print("started")
        # print(recon.shape)
