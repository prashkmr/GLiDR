...
with torch.no_grad():
  ...
  for i in npydata:
    ...
    for batch in loader:
        ...
        losses0 += [ torch.sqrt(criterion(recon.reshape(-1,3, args.beam * int(1024/args.dim)) , lidar_s.reshape(-1,3, args.beam * int(1024/args.dim)) )) ]
    ...
    print('RMSE {}: {:.8f}'.format(i, losses0))
